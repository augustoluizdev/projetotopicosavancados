...
## O que ainda falta para concluir toda a atividade do PDF

### Backend
- autenticação JWT nos WebSockets
...
### Frontend
O projeto enviado não contém Angular, então:
- não foi possível implementar o serviço SignalR/WebSocket do frontend
- não foi possível criar componente reativo de pedidos
